...
const MARKET_SESSIONS: MarketSessionConfig[] = [
  {
    id: "sydney",
    name: "Sydney",
...
const isSessionOpen = (openHour: number, closeHour: number, utcHour: number, utcMinute: number) => {
...
export const getGlobalMarketHours = () => {
  const now = new Date();
