...
// 8. My Profile
router.get("/my-profile", (0, auth_1.authMiddleware)(role_1.role.admin), user_controller_1.userController.myProfile);
router.get("/profile", (0, auth_1.authMiddleware)(role_1.role.admin), user_controller_1.userController.myProfile);
// 9. Update Profile
...
router.patch("/update-profile", (0, zodValidationHandler_1.default)(user_validation_1.userValidation.updateUserValidation), user_controller_1.userController.updateUser);
router.post("/update-profile", (0, zodValidationHandler_1.default)(user_validation_1.userValidation.updateUserValidation), user_controller_1.userController.updateUser);
// User Management
