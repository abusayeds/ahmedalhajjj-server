...
exports.sendRegistationOtpEmail = exports.sendEmail = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const nodemailer_1 = __importDefault(require("nodemailer"));
const config_1 = require("../../../config");
const sendEmail = (otp, email) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendRegistationOtpEmail = (otp, email) => __awaiter(void 0, void 0, void 0, function* () {
    const transporter = nodemailer_1.default.createTransport({
        service: "gmail",
        secure: true,
        auth: {
...
exports.sendRegistationOtpEmail = sendRegistationOtpEmail;
